 ...
 */
public class FireTravellingLeftState implements SpellState {
    ...
    public FireTravellingLeftState(Spell spell) {
        ...
        if (spriteSheet == null)
            spriteSheet = BitmapFactory.decodeResource(spell.context.getResources(), R.drawable.fire_spell_left);
