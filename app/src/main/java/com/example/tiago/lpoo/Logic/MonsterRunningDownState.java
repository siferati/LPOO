...
/**
 * A class that represents the Monster running down state
 */
public class MonsterRunningDownState implements MonsterState {
    //Attributes:
     ...
     */
    private static final int[] FRAMES = new int[]{15, 14, 13, 12, 11, 10, 9, 8};
     ...
     */
    public MonsterRunningDownState(Monster monster) {
